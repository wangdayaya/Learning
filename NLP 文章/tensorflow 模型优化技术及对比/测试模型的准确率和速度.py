...
test1('量化微调模型.h5', test_images, test_labels)
evaluate_tfilte('剪枝优化+轻量化模型.tflite', test_images, test_labels)
evaluate_tfilte('量化优化+轻量化模型.tflite', test_images, test_labels)
evaluate_tfilte('剪枝优化+量化优化+轻量化.tflite', test_images, test_labels)
...
# 量化微调模型.h5 准确率为 1.0%
# 量化微调模型.h5 耗时 0.06202530860900879s
# 量化微调模型.h5 文件大小为 79774 字节
...
# 剪枝微调模型.h5 文件大小为 25584 字节
# 量化微调模型.h5 准确率为 0.9731570512820513%
# 量化微调模型.h5 耗时 0.31646013259887695s
# 量化微调模型.h5 文件大小为 79774 字节
# 剪枝优化+轻量化模型 准确率为 0.9707532051282052%
# 剪枝优化+轻量化模型 耗时 0.28508996963500977s
# 剪枝优化+轻量化模型 文件大小为 24851 字节
# 量化优化+轻量化模型 准确率为 0.9777644230769231%
# 量化优化+轻量化模型 耗时 3.5285239219665527s
# 量化优化+轻量化模型 文件大小为 17690 字节
# 剪枝优化+量化优化+轻量化 准确率为 0.9723557692307693%
# 剪枝优化+量化优化+轻量化 耗时 0.46264100074768066s
# 剪枝优化+量化优化+轻量化 文件大小为 8044 字节